...
C                                                                       CNTL  20
C     THIS PROGRAM CONTROLS THE SUBROUTINES                             CNTL  30
C                                                                       CNTL  40
       INTEGER OUX                                                      CNTL  60
...
C                                                                       CNTL 140
C      HOB IS HEIGHT OF BURST IN KILOMETERS > 50KM                      CNTL 150
C                                                                       CNTL 160
C      GAMYLD IS GAMMA YIELD OF BURST IN KILOTONS                       CNTL 170
C                                                                       CNTL 180
C      BFIELD IS THE MAGNITLDE OF EARTHS MAGNETIC FIELD IN THE          CNTL 190
C      ABSORPTION REGICN BELOW THE BURST IN WEBERS/SQUARE METER         CNTL 200
C                                                                       CNTL 210
...
C         TP IS NEGATIVE RETARDED TIME                                  CMTN 120
C         T IS POSITIVE RETARDED TIME                                   CMTN 130
...
C                                                                       CMTN 260
      ...
      JPHI=JPHI+(RK5+2.*(RK6+RK7)+RK8)/6.                               CMTN 370
C                                                                       CMTN 380
C         RUNGE-KUTTA INTEGRATION OF PRIMARIES                          CMTN 390
C                                                                       CMTN 400
      RKP1=DT*RKCMTN(R,THETA,OMEGA,TP,TPRIME)                           CMTN 410
      RKP2=DT*RKCMTN(R,THETA,OMEGA,TP,TPRIME+W)                         CMTN 420
      RKP3=RKP2                                                         CMTN 430
      RKP4=DT*RKCMTN(R,THETA,OMEGA,TP,TPRIME+DT)                        CMTN 440
      PRI=PRI+(RKP1+2.*(RKP2+RKP3)+RKP4)/6.                             CMTN 450
      RP1=DT*RKCMTN(R,THETA,OMEGA,T,TPRIME)                             CMTN 460
      RP2=DT*RKCMTN(R,THETA,OMEGA,T,TPRIME+W)                           CMTN 470
      RP3=RP2                                                           CMTN 480
      RP4=DT*RKCMTN(R,THETA,OMEGA,T,TPRIME+DT)                          CMTN 490
      PRI2=PRI2+(RP1+2.*(RP2+RP3)+RP4)/6.                               CMTN 500
      TPRIME=TPRIME+DT                                                  CMTN 510
 31   CONTINUE                                                          CMTN 520
C                                                                       CMTN 530
C         MULTIPLY PRIMARIES BY Q*G(R)/TMAX                             CMTN 540
C         TO OBTAIN RATE OF FRODUCTION OF SECONDARIES                   CMTN 545
C                                                                       CMTN 550
      PRI=PRI*5.000E4*GOFR(R,A,HOB,PATH,GAMYLD)/TMAX                    CMTN 560
      PRI2=PRI2*5.0E4*GOFR(R,A,HOB,PATH,GAMYLD)/TMAX                    CMTN 570
      RETURN                                                            CMTN 580
      END                                                               CMTN 581
C
C
